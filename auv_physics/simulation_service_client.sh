...
rosservice call /physics_simulator/simulation_cmd "{command: {header: {stamp: now, frame_id: world}, type: 2, initial_pose: {position: {x: 0, y: 0, z: 0}, orientation: {x: 0, y: 0.0 , z: 0, w: 1.0} }, initial_velocity: {linear: {x: 0.0, y: 0, z: 0}, angular: {x: 0, y: 0, z: 0.0} } } }"
