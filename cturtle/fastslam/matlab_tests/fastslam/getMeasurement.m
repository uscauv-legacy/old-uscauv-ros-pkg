...
%function [landmark_distance, landmark_angle] = getMeasurement(pos, landmark_pos)
%  vector_to_landmark = [landmark_pos(1) - pos(1);
%                        landmark_pos(2) - pos(2)];
%
%  angle_to_landmark = atan2(vector_to_landmark(2), ...
%                            vector_to_landmark(1));
%
%  landmark_angle = angle_to_landmark - pos(3);
%  landmark_distance = pdist([landmark_pos';pos(1:2)']);
%
%end
